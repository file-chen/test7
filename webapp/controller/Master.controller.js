/*global history */
sap.ui.define([
		"com/cs/test/test6/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"com/cs/test/test6/model/formatter",
		"com/cs/test/test6/model/grouper",
		...
		return BaseController.extend("com.cs.test.test6.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.cs.test.test6.view.ViewSettingsDialog", this);
