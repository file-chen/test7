sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("com.cs.test.test6.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias com.cs.test.test6.controller.ListSelector
			 */
			 ...
			 * @return {com.cs.test.test6.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
