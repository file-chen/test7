sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/cs/test/test6/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.cs.test.test6.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/cs/test/test6/localService/mockserver"], function (mockserver) {
